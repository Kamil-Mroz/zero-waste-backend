...
CREATE TABLE offers (
    ...
    CONSTRAINT uk_offer_buyer_item UNIQUE (buyer_id, item_id),
    CONSTRAINT fk_offer_buyer FOREIGN KEY (buyer_id) REFERENCES users (id) ON DELETE CASCADE,
    CONSTRAINT fk_offer_item FOREIGN KEY (item_id) REFERENCES items (id) ON DELETE CASCADE
);
...
CREATE TABLE user_bans (
    ...
    CONSTRAINT fk_user_ban_banned_by FOREIGN KEY (banned_by) REFERENCES users (id)
);
