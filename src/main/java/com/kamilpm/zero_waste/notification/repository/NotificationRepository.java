package com.kamilpm.zero_waste.notification.repository;
...
public interface NotificationRepository extends JpaRepository<Notification, UUID> {
  ...
  @Transactional
  @Modifying
  @Query("update Notification n set n.read = true where n.read = false and n.id = :notificationId and n.recipientId = :recipientId")
  void markAsRead(@Param( "notificationId") UUID notificationId, @Param( "recipientId") UUID recipientId);

  @Transactional
  @Modifying
  @Query("update Notification n set n.read = true where n.read = false and n.recipientId = :recipientId")
  ...
  Optional<Notification> findByIdAndRecipientId(UUID notificationId, UUID userId);

  void deleteByRecipientIdIn(List<UUID> ids);
}
